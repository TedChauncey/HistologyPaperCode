...
img_rows, img_cols = 100, 100 # 50, 50 #normally. make sure this is an even number   
#### DEFINE MODEL########
...
Outcomes_file = '/home/chintan/Desktop/AAPM/ModelsandData/Data/AdenoSquamTrain.csv' #define the outcomes file, sorted according to PID
...
#save model 
fname = "AdenovSCC_Preprocessed.h5"
model.save(fname)
